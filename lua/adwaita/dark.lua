...
M.set = function ()
    ...
    highlight('Directory',              colors.blue_1,              colors.libadwaita_dark,     'none',      'none' )
    ...
    highlight('ErrorMsg',               colors.red_1,               colors.libadwaita_dark,     'underline', 'none' )
    ...
    highlight('Special',                colors.red_1,               'none',                     'none',      'none' )
    highlight('SpecialChar',            colors.red_1,               'none',                     'none',      'none' )
    ...
    highlight('SpellBad',               colors.red_1,               'none',                     'undercurl', 'none' )
    highlight('SpellCap',               colors.red_1,               'none',                     'undercurl', 'none' )
    highlight('SpellRare',              colors.red_1,               'none',                     'undercurl', 'none' )
    highlight('SpellLocal',             colors.red_1,               'none',                     'undercurl', 'none' )
    highlight('Whitespace',             colors.libadwaita_dark_alt, 'none',                     'none',      'none' )


    highlight('TSError',                colors.red_1,               'none',                     'undercurl', 'none' )
    highlight('TSTSPunctBracket',       colors.light_4,             'none',                     'undercurl', 'none' )
    highlight('TSPunctSpecial',         colors.red_1,               'none',                     'undercurl', 'none' )
    ...
    highlight('TSTitle',                'none',                     'none',                     'bold',      'none' )
    ...
    highlight('TSTextReference',        colors.blue_2,              'none',                     'italic',    'none' )
    highlight('TSPunctDelimiter',       'none',                     'none',                     'italic',    'none' )
