...
M.set = function()
    ...
    hl('Number', { fg = colors.teal_3, bold = true })
    hl('Boolean', { fg = colors.purple_2, bold = true })
    hl('Float', { fg = colors.teal_3, bold = true })
    hl('Boolean', { fg = colors.purple_2, bold = true })
    hl('Identifier', { fg = colors.orange_2, bold = true })
    ...
    hl('Operator', { fg = colors.purple_2, bold = true })
    ...
    hl('Whitespace', { fg = colors.dark_3, underline = true })
    ...
    hl('@number', { fg = colors.teal_2, bold = true })
    ...
    hl('@variable.builtin', { fg = colors.orange_2 })
    hl('@variable.parameter', { fg = colors.orange_2 })
    ...
    hl('@interface', { link = 'Identifier' })
    hl('@modifier', { link = 'Identifier' })
    hl('@regexp', { fg = colors.purple_2, bg = 'NONE' })
