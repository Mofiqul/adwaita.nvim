...
M.set = function ()
    ...
    highlight('VertSplit',                     colors.light_3,  colors.light_2, 'none',      'none' )
    highlight('Folded',                        colors.light_3,  colors.light_2, 'none',      'none' )
    highlight('FoldedColumn',                  colors.light_3,  colors.light_2, 'none',      'none' )
    ...
    highlight('NvimTreeFolderIcon',            colors.blue_4,   'none',         'none',      'none' )
    highlight('NvimTreeFolderName',            colors.dark_4,   'none',         'bold',      'none' )
    highlight('NvimTreeEmptyFolderName',       colors.dark_4,   'none',         'bold',      'none' )

    highlight('LspFloatWinNormal',             colors.dark_3,   colors.light_3, 'none',      'none' )
    highlight('LspFloatWinBorder',             colors.light_3,  colors.light_3, 'none',      'none' )
    highlight('LspSagaHoverBorder',            colors.light_3,  colors.light_3, 'none',      'none' )
    highlight('LspSagaSignatureHelpBorder',    colors.light_3,  colors.light_3, 'none',      'none' )
    highlight('LspSagaCodeActionBorder',       colors.light_3,  colors.light_3, 'none',      'none' )
    highlight('LspSagaDefPreviewBorder',       colors.light_3,  colors.light_3, 'none',      'none' )
    highlight('LspLinesDiagBorder',            colors.light_3,  colors.light_3, 'none',      'none' )
    highlight('LspSagaRenameBorder',           colors.light_3,  colors.light_3, 'none',      'none' )
    highlight('LspSagaBorderTitle',            colors.light_3,  colors.light_3, 'none',      'none' )
    highlight('LSPSagaDiagnosticTruncateLine', colors.light_3,  colors.light_3, 'none',      'none' )
    highlight('LspSagaDiagnosticBorder',       colors.light_3,  colors.light_3, 'none',      'none' )
    highlight('LspSagaShTruncateLine',         colors.light_6,  colors.light_3, 'none',      'none' )
    highlight('LspSagaDocTruncateLine',        colors.light_6,  colors.light_3, 'none',      'none' )
    highlight('LspSagaLspFinderBorder',        colors.light_3,  colors.light_3, 'none',      'none' )

    highlight('TelescopePromptBorder',         colors.light_3,  colors.light_3, 'none',      'none' )
    highlight('TelescopeResultsBorder',        colors.light_3,  colors.light_3, 'none',      'none' )
    highlight('TelescopePreviewBorder',        colors.light_3,  colors.light_3, 'none',      'none' )
    highlight('TelescopeNormal',               colors.dark_3,   colors.light_3, 'none',      'none' )
    ...
    highlight('CompeDocumentationBorder',      colors.light_3,  colors.light_3, 'bold',      'none' )
end
