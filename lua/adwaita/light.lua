...
M.set = function()
    ...
    hl('FoldedColumn', { fg = colors.dark_1 })
    ...
    hl('CmpNDocBorder', { fg = colors.light_5 })

    hl('CocHighlightText', { bg = colors.blue_1 })
    hl('CocHighlightRead', { bg = colors.blue_1 })
    hl('CocHighlightWrite', { bg = colors.blue_1 })


    hl('GitSignsAddLn', { fg = colors.green_6, bg = colors.green_2 })
    hl('GitSignsChangeLn', { fg = colors.orange_5, bg = colors.orange_1 })
    hl("GitSignsCurrentLineBlame", { fg = colors.dark_1 })
end
